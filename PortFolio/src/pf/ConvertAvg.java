...
//				System.out.println("[" + i + "] min : " + minColor[i] + " || max : " + maxColor[i]);
			...
			ImageIO.write(outputAvgColor1, "png", new File("C:/te/컬러리스트/출력/Avg1.png"));
			ImageIO.write(outputAvgColor2, "png", new File("C:/te/컬러리스트/출력/Avg2.png"));
			System.out.println("출력 완료");
			
			ImageMerge.RunOriginMerge(); // 이미지 붙이기
			ImageMerge.RunAvgMerge(); // 이미지 붙이기
//			try {
//				ImageIO.write(outputColor0, "png", new File("C:/te/컬러리스트/출력/B1.png"));
//				ImageIO.write(outputColor1, "png", new File("C:/te/컬러리스트/출력/B2.png"));
//				ImageIO.write(outputColor2, "png", new File("C:/te/컬러리스트/출력/L.png"));
